...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sheet.user'
        db.add_column('sheets_sheet', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], default=1),
                      keep_default=False)

        # Adding field 'Sheet.name'
        db.add_column('sheets_sheet', 'name',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=255, default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sheet.user'
        db.delete_column('sheets_sheet', 'user_id')

        # Deleting field 'Sheet.name'
        db.delete_column('sheets_sheet', 'name')
